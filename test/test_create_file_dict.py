...
def test_form_chr_num():
    ...
    chr_num_1: str = file_dict_creator.form_chr_num(9)
    chr_num_2: str = file_dict_creator.form_chr_num(11)
...
def test_find_match_carrier():
    ...
    assert "chr19" in file_dict_creator.find_match(file_list, "chr19", "carrier")
...
def test_find_match_ibd():
    ...
    if not "chr1." in file_dict_creator.find_match(file_list, "chr01", "ibd"):
        errors.append("chr1. was not found within the output file")

    if not "chr10" in file_dict_creator.find_match(file_list, "chr10", "ibd"):
...
def test_find_match_map():
    ...
    assert "chr10" in file_dict_creator.find_match(file_list, "chr10", "map")
...
def test_get_file_dict():
    ...
    file_dict: dict = file_dict_creator.get_file_dict(
