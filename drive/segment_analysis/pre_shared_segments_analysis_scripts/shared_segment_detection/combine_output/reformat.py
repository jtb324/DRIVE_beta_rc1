            ...
            for variant in variant_list:
                ...
                try:
                    ...
                    if carrier_int == 1:
                        ...
                        print(f"The variant, {variant}, failed. This error means the variant has carriers identified by the mega array but there were no pairs of individuals that shared ibd segments along the variant location\n")
