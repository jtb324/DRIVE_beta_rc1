...
class Csv_Writer_Object:
    def __init__(self, var_dictionary, write_directory, file_name):
        '''This is invoked when the class is instantiated. The class requires a dictionary to be passed. A name for the directory it will be written to, a filename for the output file.'''
    ...
    def write_to_csv(self):
        ...
        with open(
                file_creator_scripts.writePath(self.output_directory,
            ...
            ):  # This line iterates through the keys and values in the multiVarDict
