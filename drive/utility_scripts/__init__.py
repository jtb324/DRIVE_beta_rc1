...
from .readme_generators.readme_body_text import main_parameter_text, main_directory_text, main_directory_header, plink_readme_body_text, carrier_analysis_body_text, formatted_ibd_dir_body_text_1, formatted_ibd_dir_body_text_2, haplotype_analysis_body_text, networks_body_text
from .readme_generators.generator_decorator import class_readme_generator
